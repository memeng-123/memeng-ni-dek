...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'varrellcoding@gmail.com',
    href: 'mailto:varrellcoding@gmail.com',
  },
  {
    icon: Phone,
    label: 'Telepon',
    value: '+62 822-1023-0378',
    href: 'tel:+6282210230378',
  },
  {
    icon: MapPin,
    label: 'Lokasi',
    value: 'Banda Aceh, Indonesia',
    href: 'https://maps.app.goo.gl/8wGwmLjEDQzcwV4d6#',
  },
];
